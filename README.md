...
[![Latest Release](https://img.shields.io/github/v/release/mlmateos/texstudio-qt6-builds?include_prereleases&label=latest)](https://github.com/mlmateos/texstudio-qt6-builds/releases)
...
| `--branch NAME` | Branch or tag to compile (e.g., `4.9.5`, `4.9.6alpha4`, `master`) |
...
### Example Workflows
    ...
    ./build-texstudio-deb.sh --branch 4.9.6alpha4 --clean --poppler --sign --publish
...
| Type | Version | Branch |
|------|---------|--------|
| 🟡 Development | 4.9.6-alpha4 | `alpha` |
