...
| `--branch NAME` | Branch or tag to compile (e.g., `4.9.5`, `4.9.6beta1`, `master`) |
...
### Example Workflows
    ...
    ./build-texstudio-deb.sh --branch 4.9.6beta1 --clean --poppler --sign --publish
